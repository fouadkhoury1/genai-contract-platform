    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#121417', fontFamily: 'Inter' }}>
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white" style={{ fontFamily: 'Inter' }}>Create Account</h2>
          <p className="mt-2 text-sm" style={{ color: '#9CABBA', fontFamily: 'Inter' }}>Sign up for a new account</p>
        </div>
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-white mb-2" style={{ fontFamily: 'Inter' }}>
                Confirm Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              {errors.confirmPassword && (
                <p className="mt-1 text-sm text-red-400" style={{ fontFamily: 'Inter' }}>{errors.confirmPassword.message}</p>
              )}
            </div>
            <button
              type="submit"
          ...
          <div className="mt-6 text-center">
            <p className="text-sm" style={{ color: '#9CABBA', fontFamily: 'Inter' }}>
              ...
              <a href="/login" className="font-medium text-white hover:text-white/80 transition-colors duration-200" style={{ fontFamily: 'Inter' }}>
                Sign in
              </a>
            </p>
          </div>
